...
UInt32 cProtocol_1_13::GetRemappedEntityID(char a_EntityID)
{
	switch (a_EntityID)
	{
		case 20:                      return 55; // TNT
		default:                      return a_EntityID;
	}
}
...
UInt32 cProtocol_1_13::GetRemappedMobID(char a_MobType)
{
	switch (a_MobType)
	{
		case mtBat:                   return 3;
...
void cProtocol_1_13::SendSpawnMob(const cMonster & a_Mob)
{
	...
	Pkt.WriteVarInt32(GetRemappedMobID(a_Mob.GetMobType()));
...
void cProtocol_1_13::SendSpawnObject(const cEntity & a_Entity, char a_ObjectType, int a_ObjectData, Byte a_Yaw, Byte a_Pitch)
{
	ASSERT(m_State == 3);  // In game mode?
	...
	Pkt.WriteBEUInt8(GetRemappedEntityID(a_ObjectType));
...
void cProtocol_1_13::SendPickupSpawn(const cPickup & a_Pickup)
{
	ASSERT(m_State == 3);  // In game mode?
	...
	{  // TODO Use SendSpawnObject
		...
		Pkt.WriteBEUInt8(32);  // Type = Pickup
